 ...
 *
 * FIXED: Updated PWM API for ESP32 Arduino Core 2.x/3.x compatibility
 */
...
void loop()
{
  ...
  // Set LED brightness
  ledcWrite(LED_PIN, brightness); // FIXED: Use pin directly in newer API
...
void setupPWM()
{
  // FIXED: Updated PWM setup for ESP32 Arduino Core 2.x/3.x

  // Method 1: Using ledcAttach (simplest - ESP32 Arduino Core 3.x)
  ...
  /*
   * Alternative Method for older ESP32 Arduino Core 2.x:
   * Uncomment below and comment out the ledcAttach line above
   *
